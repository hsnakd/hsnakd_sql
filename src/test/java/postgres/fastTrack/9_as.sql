...
select concat(first_name, last_name, '@gmail.com') as full_email from EMPLOYEES;

select concat('Cydeo ',concat(EMAIL,'@gmail.com')) as full_email from EMPLOYEES;

--UPPER (varchar)
select UPPER(first_name || last_name ||'@gmail.com') as full_email from EMPLOYEES;
-- Steven KING
select FIRST_NAME||' '|| UPPER(LAST_NAME) as full_name from EMPLOYEES;

--LOWER (varchar)
select LOWER(first_name || last_name ||'@gmail.com') as full_email from EMPLOYEES;
